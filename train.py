...
from model.DFBNet import DFBNet
...
def train(epoch, model, dataloader, optimizer, training):
    ...
    model.train_mode() if training else model.eval() # fix bug
...
if __name__ == '__main__':
    ...
    model = DFBNet(args.backbone, args.feature_extractor_path, False, args.nshot)
